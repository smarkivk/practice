...
public class MyFirstJavaAppML {
    ...
    public static void main(String[] args) {
        ...
        //long registrationNumber = 134513532145234553;
        long registrationNumber = 134513532145234553L;//by default its int then L used for long
        float fuelConsumptionCombined = 15.5F;
        float fuelConsumptionUrban = 21.4F;
        float fuelConsumptionExtraUrban = 13.6F;

        double fuelConsumptionPreciseAverage = 153.2452345234525E-1;//WHY E E^-1;
        ...
        byte newPower = (byte) power;//big to small ( short16 to byte8)
